 ...
 */
/**
 * Elasticsearch Control Panel classes.
 */
@Configuration
@Requires(classes = ElasticsearchAsyncClient.class)
@Requires(property = ElasticsearchControlPanel.ENABLED_PROPERTY, notEquals = StringUtils.FALSE)
